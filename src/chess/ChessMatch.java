...
public class ChessMatch {
    ...
    public ChessPiece perform(ChessPosition sourcePosition, ChessPosition targetPosition) {
    ...
    private Piece makeMove(Position source, Position target) {
        ...
        if (p instanceof King && target.getColumn() == source.getColumn() - 2) {
            ...
            Position targeT = new Position(source.getRow(), target.getColumn() - 1);
    ...
    private ChessPiece king(Color color) {
        List<Piece> list = pieceOnTheBoard.stream().filter(
        ...
        throw new IllegalStateException("There is no " + color + "King the borad");
    }

    private boolean testCheck(Color color) {
        Position kingPosition = king(color).getChessPosition().toPosition();
        List<Piece> opponentPieces = pieceOnTheBoard
